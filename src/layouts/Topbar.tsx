...
export function Topbar({
  ...
  return (
    <header className="w-full h-16 flex-shrink-0 border-b border-border-custom bg-panel/30 backdrop-blur-md flex items-center justify-between px-6 z-50 select-none">
      ...
      {/* Center Console Telemetry Displays exactly like the mock */}
      ...
      <div className="flex items-center gap-3">
        {/* Toggle Button: Solid orange style */}
        <button
        ...
        >
          <span className="w-2.5 h-2.5 rounded-full border border-current flex items-center justify-center text-[5px]">●</span>
